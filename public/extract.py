...
directory = r"C:\Users\umair\Desktop\Github\sanam-demo\public"
...
# Walk through the directory and process only files starting with 'ar_'
for root, _, files in os.walk(directory):
    for file in files:
        if file.startswith("ar_") and file.endswith(".html"):
